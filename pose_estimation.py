...
class PoseEstimator:
    ...
    ###
    ### add 3 function to detect distraction
    ###
    ...
    def is_distracted(self, rotation_vector):
        ...
        pitch_threshold = (-15, 10)  # Up/Down threshold
        yaw_threshold = (-20, 16)     # Left/Right threshold
        roll_threshold = (-180, 180) # Tilt threshold
